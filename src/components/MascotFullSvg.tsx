...
export interface MascotFullSvgProps {
  width?: number;
  height?: number;
  style?: StyleProp<ViewStyle>;
}

export default function MascotFullSvg({
  width = 384,
  height,
  style,
}: MascotFullSvgProps) {
  ...
  return (
    ...
    >
      ...
      {/* Left cloud ear / hair tuft (blue base + white puffy) */}
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      {/* Body highlights and main yellow circle */}
      ...
      {/* Belly stripes masked to body circle */}
      <Mask
        id="mask0_belly_stripes"
      ...
      <G mask="url(#mask0_belly_stripes)">
      ...
      {/* Right cloud ear / hair tuft (blue base + white puffy) */}
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <Ellipse
        ...
        rx={21.4478}
        ry={21.4192}
        transform="matrix(0.999985 0.00539685 -0.0053573 0.999986 132.906 75.2329)"
        fill="#FAFAFA"
      />
      <Ellipse
        cx={7.79026}
        ...
        rx={7.79026}
        ry={7.77986}
        transform="matrix(0.999986 0.00536986 -0.00538422 0.999985 152.543 96.9883)"
        fill="#363B43"
      />
      <Path
      ...
      <Ellipse
        ...
        rx={21.4478}
        ry={21.4192}
        transform="matrix(0.999985 0.00539685 -0.0053573 0.999986 196.928 75.2329)"
        fill="#FAFAFA"
      />
      <Ellipse
        cx={7.79026}
        ...
        rx={7.79026}
        ry={7.77986}
        transform="matrix(0.999986 0.00536986 -0.00538422 0.999985 204.117 96.9883)"
        fill="#363B43"
      />
      <Path
      ...
      <Rect
        ...
        height={11.2783}
        rx={5.63916}
        transform="matrix(-0.902148 -0.431427 -0.432287 0.901736 129.537 126.331)"
        fill="#2F2E41"
        fillOpacity={0.12}
      />
      <Rect
        ...
        height={11.2782}
        rx={5.6391}
        transform="matrix(0.9436 -0.331087 0.331967 0.943291 243.1 125.955)"
        fill="#2F2E41"
        fillOpacity={0.12}
      />
      ...
      {/* Left arm waving up */}
      <Path
        d="M46.0763 80.8365C39.8942 75.3415 30.9073 83.1261 27.1866 87.7053C18.9438 78.0883 10.5866 83.6982 7.43839 87.7053C-22.7851 133.041 46.3626 170.133 84.7143 183.012L93.3005 122.909L67.5418 113.464L46.0763 100.585C48.6521 96.2917 52.2584 86.3316 46.0763 80.8365Z"
        fill="#F5C857"
      />

      {/* Right arm outstretched */}
      <Path
        d="M357.648 129.01C365.861 129.995 365.991 141.884 365.03 147.705C377.694 147.5 379.035 157.476 378.123 162.489C364.221 215.172 290.609 187.998 255.54 167.826L294.843 121.55L318.991 134.572L342.864 142.103C344.37 137.328 349.436 128.025 357.648 129.01Z"
        fill="#F5C857"
      />
